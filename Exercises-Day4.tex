...
\addcontentsline{toc}{section}{Exercise 8: Export Selenium Test to
...
\addcontentsline{toc}{section}{Exercise 9: Using the API, Test Document Routing, Verify ActionList}
{\setlength{\baselineskip}%
  {0.0\baselineskip}
